...
void drawButton(int i)
{
  ...
  if (trials.get(trialNum) == i) // if button is target, place star inside of it
    star(bounds.x + 20, bounds.y + 20, 10, 14, 5);
}
void star(float x, float y, float radius1, float radius2, int npoints) { // Creates a star shape.
